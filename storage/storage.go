...
type AuthentificationRepoI interface {
	Register(ctx context.Context, req *models.CreateUser) (string, error)
	Login(ctx context.Context, req *models.Login1) (string, error)
}
